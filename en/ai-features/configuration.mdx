...
Keys are stored in macOS Keychain. More: [BYOK](/en/subscribe/byok).

## Embedding matters

Without a working Embedding model:

- [Semantic search](/en/search/semantic-search) is unavailable  
- [RAG index](/en/knowledge-base/index-management) cannot build the vector side  
...
Default follows UI language; you can set AI output language separately. See [AI settings](/en/settings/ai).

## Related

- [Auto Tidy](/en/ai-features/auto-tidy)
- [FAQ · AI](/en/faq/ai)
