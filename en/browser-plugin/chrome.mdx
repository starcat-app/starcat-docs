...
2. You should see Starcat enhancements (notes / Health, etc. — see [Features](/en/browser-plugin/features))  
3. If missing: check extension permissions, port/token, and whether the app is running  

## Related

- [Integrations settings](/en/settings/integrations)
- [Safari](/en/browser-plugin/safari)
