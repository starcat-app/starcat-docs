...
1. Is Pro active? → [Restore purchase](/en/subscribe/restore)  
2. Does Embedding pass test? → [AI configuration](/en/ai-features/configuration)  
3. Is the target repo actually ingested? → [Adding repos](/en/knowledge-base/adding-repos)  
4. Did @ accidentally exclude key repos? → [RAG workspace](/en/knowledge-base/rag-workspace)  
5. Chat only, Embedding empty → add Embedding  

## Related

- [Citations](/en/knowledge-base/citations)
- [FAQ · AI](/en/faq/ai)
