...
3. Use [batch multi-select](/en/manage-stars/batch-operations) when needed  
...
|-----------|-------------|------|
| **Status** | unread / read / using | [Notes and status](/en/manage-stars/notes-and-status) |
| **Starred / not starred** | Top bar may also offer a quick toggle | — |
| **Knowledge base** | Ingested / not ingested | [Knowledge base](/en/knowledge-base/overview) |
| **Language** | Multi-select; pairs with “languages of interest” | [List preferences](/en/settings/list-preferences) |
| **Tags** | Filter by tag | [Tags](/en/manage-stars/tags) |
| **Wiki** | Repos with Wiki signals | Wiki entry on detail |
| **Health** | Repos with cached health scores | [Repo Health](/en/main-interface/repo-health) |
...
When all three apply, remember the current list is already a filtered subset. See [List search](/en/search/global-search).
...
- If behavior seems wrong: [General settings](/en/settings/general) → reset list preferences  

## Related

- [Smart collections](/en/manage-stars/smart-collections) (rule filters ≈ savable filters)
