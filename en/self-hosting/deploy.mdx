...
- Cloning each [GitHub repo](/en/self-hosting/overview) separately, or  
...
Paste the public HTTPS URL (or LAN `http://IP:port`) and one key from `API_KEYS` into Starcat — see [Configure in Starcat](/en/self-hosting/configure).
