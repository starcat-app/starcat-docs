...
If all APIs are running per [Deploy](/en/self-hosting/deploy):
...
- [Overview](/en/self-hosting/overview)
- [Deploy](/en/self-hosting/deploy)
- [Integrations](/en/settings/integrations) (plugins / External Search — different from these APIs)
