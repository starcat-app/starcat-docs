...
- Requires [Pro](/en/subscribe/plan-comparison)  
- A local or trusted-network [CLI](/en/cli/installation) reaches app capabilities through MCP  
...
Full details: [CLI installation](/en/cli/installation), [CLI usage](/en/cli/usage).
