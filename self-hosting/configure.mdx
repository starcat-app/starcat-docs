...
Point the app at a custom instance root URL and key. Most users leave the fields empty. RAG Meilisearch / Qdrant are configured under Settings → AI.
...
1. URL is the service root only: no business path, no extra trailing slash.
...
- [Integrations](/settings/integrations) (plugin token and External Search)
