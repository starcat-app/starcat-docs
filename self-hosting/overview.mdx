...
Most users **do not** need to self-host. Starcat ships with default Fly.io endpoints and baked-in API keys. This topic is for advanced users who want to inspect the source, run APIs locally, or point Explore / Weekly / Sharing at their own instances. Direct license / payment is **not** under **Settings → Services**.
